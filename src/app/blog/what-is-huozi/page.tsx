...
const post = getPost("what-is-huozi")!;
...
export default async function WhatIsHuoziPost() {
  ...
  return (
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <header className="mb-12 border-b border-border/60 pb-8">
        ...
        <h1 className="mt-3 font-serif text-4xl sm:text-5xl font-bold leading-tight tracking-tight">
          {zh.title}
        </h1>
        <h2 className="mt-2 font-serif text-2xl sm:text-3xl font-normal leading-tight tracking-tight text-muted-foreground">
          {en.title}
        </h2>
        <p className="mt-6 text-lg leading-relaxed">{zh.excerpt}</p>
        <p className="mt-3 text-base text-muted-foreground leading-relaxed italic">
          {en.excerpt}
        </p>
      </header>
