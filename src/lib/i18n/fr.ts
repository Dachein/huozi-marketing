export const fr = {
  ...
  "start.authorize.example":
    "→ Ouvrez https://cloud.huozi.app/device?code=ABCD-1234 et cliquez sur Authorize.",
  ...
  "start.picker.content.claude-code.mcp.step2":
    "Step 2 · Dans Claude Code, tapez /mcp → sélectionnez huozi → Authenticate. Un clic dans le navigateur et les outils huozi sont disponibles dans la session courante.",
  ...
  "start.picker.content.cursor.mcp.body":
    "Cliquez le bouton ci-dessous — Cursor gère nativement via le protocole cursor://, écrit sa propre config, sans toucher à ~/.cursor/mcp.json ni recharger. Le premier appel à huozi ouvre le navigateur pour OAuth-on-first-use.",
  "start.picker.content.cursor.mcp.button": "Ajouter à Cursor",
